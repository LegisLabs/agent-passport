...
with sync_playwright() as pw:
    ...
    page.goto(BASE+"/terminal?console=1"); page.wait_for_selector("#chain-toggle")
    ...
    m=b.new_context(viewport={"width":390,"height":844}).new_page(); m.goto(BASE+"/terminal?console=1"); m.wait_for_timeout(800)
