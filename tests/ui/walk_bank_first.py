...
with sync_playwright() as pw:
    ...
    check("business current account tier" in low(page, "#cu-limits") and "gbp only" in low(page, "#cu-limits"), "agent-channel limits from the account tier shown on the form")
