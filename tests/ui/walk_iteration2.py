...
def issue(page, sign=True):
    ...
    page.goto(BASE + f"/regulator?ref={ref}"); page.wait_for_selector("#rg-case:not([hidden])")
...
def invoice(page, which):
    page.goto(BASE + "/bank?console=1"); page.wait_for_selector("#invoice-buttons button")
...
def main():
  with sync_playwright() as pw:
      ...
      page.goto(BASE + f"/regulator?ref={ref}"); page.wait_for_selector("#review > li")
      ...
      page.goto(BASE + f"/regulator?passport={pid}"); page.wait_for_selector("#ex-actions button")
      ...
      page.goto(BASE + "/bank?console=1"); page.wait_for_selector("#beats button"); page.locator("#beats button").nth(7).click(); page.wait_for_selector("#term-lines li .t-verdict", state="attached")
      check("r.2" in low(page, "#term-lines li:has(.t-verdict)"), "suspended: probe DENY R.2")
      page.goto(BASE + f"/regulator?passport={pid}"); page.wait_for_selector("#ex-actions button"); page.fill("#rg-reason", "misuse confirmed")
      ...
      pid2 = issue(page)
      invoice(page, 1)
      page.goto(BASE + f"/regulator?passport={pid2}"); page.wait_for_selector("#ex-actions button"); page.fill("#rg-reason", "looks odd")
      page.click("#ex-actions button:has-text('Suspend')"); page.wait_for_function("document.querySelector('#ex-state').innerText.toLowerCase().includes('suspended')")
