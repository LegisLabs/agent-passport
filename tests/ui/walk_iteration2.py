...
def main():
  with sync_playwright() as pw:
      ...
      page.goto(BASE + "/bank"); page.wait_for_selector("#beats button"); page.locator("#beats button").nth(7).click(); page.wait_for_selector("#term-lines li .t-verdict", state="attached")
