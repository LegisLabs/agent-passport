...
- `agent-passport-northgate.json`: our own manifest, seeded on the rail with `scripts/vouch_complete_seed.ts`, mirroring the demo mandate (three suppliers, £10,000 cap, Agent 247). `PAYMENT_RAIL=vouch` settles ALLOWed instructions against it.
